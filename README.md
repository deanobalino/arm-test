...
For more information, see https://docs.microsoft.com/en-us/azure/devops/repos/git/auth-overview?view=vsts. Your alternative credentials ($USER@microsoft.com and the password you supplied) will be used for the git clone prompts.
